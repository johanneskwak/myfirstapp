...
job_recommendations = {
    ...
    "ENFJ": ["교사", "HR 매니저", "공익 홍보 전문가"],
    "ENFP": ["방송 작가", "콘텐츠 크리에이터", "여행 기획자"],
    "ISTJ": ["회계사", "데이터 관리자", "법률 보조원"],
    "ISFJ": ["초등교사", "간호사", "사서"],
    "ESTJ": ["프로젝트 매니저", "행정 관리자", "운영 관리자"],
...
roadmaps = {
    ...
    "회계사": [
        "🎨 중·고등학교: 경제, 수학 등 다양한 과목에서 기초 실력 다지기",
        "🎓 대학교: 경영학, 회계학, 경제학 등 다양한 전공, 및 회계사 시험(1차 및 2차) 준비",
        "🖌 추가: 에듀윌, 나무 등 다양한 회계사 준비 학원 및 경영 및 컴퓨터 학점 획득 후 회계사 시험 응시 가능"
    ],    
    "교사": [
        "🎨 중·고등학교: 국어, 사회, 기술, 영어 등 다양한 과목에서 흥미를 찾고 기초 실력 다지기",
        "🎓 대학교: 다양한 사범대 전공(국어교육, 수학교육, 영어교육 등) 전공 또는 일반학과 진학 후 교직이수.",
        "🖌 추가: 대학 또는 교육대학원을 통해 교원자격증 취득 후 임용시험 또는 기간제교사로 근무"
    ],    
}
